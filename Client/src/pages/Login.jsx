  ...
  return (
   ...
   <div className="signup-form">
        ...
        <div class="circle">
          ...
          <svg width="100" height="100" viewBox="0 0 3 3" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="#8C92AD" cx="12" cy="6" r="4" d="M2 0.75a0.5 0.5 0 0 1 -0.5 0.5 0.5 0.5 0 0 1 -0.5 -0.5 0.5 0.5 0 0 1 1 0"/><path fill="#8C92AD" d="M2.5 2.186c0 0.309 0 0.564 -1 0.564S0.5 2.5 0.5 2.186 0.95 1.623 1.5 1.623s1 0.25 1 0.564"/></svg>
          </p>
        </div>
